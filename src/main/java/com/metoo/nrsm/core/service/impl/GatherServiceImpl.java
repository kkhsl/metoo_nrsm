...
//
//    @Autowired
//    private ExecutorService taskExecutor; // 注入自定义的 ExecutorService
//
//    @Override
//    public void gatherIpv4Thread(Date date) {
...
//            for (NetworkElement networkElement : networkElements) {
//
//                taskExecutor.execute(new GatherIpV4Runnable(networkElement, date));
//
//            }
//
//        }
...
//                thread.start();
            ...
            try {
                ...
                log.info("ipv6 latch run end......" + latch.getCount());
