package com.metoo.nrsm.core.traffic.factory;
...
import com.metoo.nrsm.core.traffic.gather.ganzhou.TrafficFactoryGanzhouSelfImpl;
import com.metoo.nrsm.core.traffic.gather.guixi.TrafficFactoryImplGuixi;
import com.metoo.nrsm.core.traffic.gather.yingtan.TrafficFactoryImplYingtan;
import com.metoo.nrsm.core.traffic.gather.yuehu.TrafficFactoryImplYuehu;
...
//                return new TrafficFactoryGanzhouImpl();
                return new TrafficFactoryGanzhouSelfImpl();
            }
